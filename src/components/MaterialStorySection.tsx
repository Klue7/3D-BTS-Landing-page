...
export function MaterialStorySection() {
  const { materialStory } = productData;
      ...
      <div className="container mx-auto px-6 md:px-16 grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col justify-center z-20">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-[#22c55e] text-[10px] md:text-xs font-bold tracking-widest uppercase">PERFORMANCE METRICS</span>
          </div>
          
          <h2 className="text-5xl md:text-8xl font-['Anton'] text-white uppercase tracking-tighter leading-[0.85] mb-12 md:mb-16">
            {materialStory.title}<br/>
            <span className="text-transparent" style={{ WebkitTextStroke: '1px rgba(255,255,255,0.8)' }}>{materialStory.subtitle}</span>
          </h2>
